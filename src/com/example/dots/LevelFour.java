...
public class LevelFour implements Level {
    ...
    private int numTrials2 = 100;
    private double requiredAccuracy2 = 1.0;
    ...
    public boolean graduateLevel()
    {
        if((trials.size() >= numTrials && trials.percentCorrect() >= requiredAccuracy) ||
                (trials2.size() >= numTrials2 && trials2.percentCorrect() >= requiredAccuracy2))
        {
            return true;
        }
        else
