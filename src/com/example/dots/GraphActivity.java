...
/**
 * Defines the graph of the original version of the test.
 * Using an external api, plots information based on each
 * individual input for correctness and time taken.
 */
public class GraphActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            System.out.println("Data.txt was not found");
        }
        int trialNum = 1;
        while(input.hasNext())
        {
    ...
    public void createMPGraph()
    {
        ...
        //File file = new File(Environment.getExternalStorageDirectory()+"/"+fileName);
        File file = new File(getExternalFilesDir(null),/*LoginSignupActivity.usernameFileData.get(0)*/"data.txt");
        System.err.println(getExternalFilesDir(null));
        Scanner input = new Scanner(System.in);
