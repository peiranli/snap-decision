...
/**
 * The view graph activity for the app. Is based on the
 * graph activity for the default levels version of the app.
 */
public class TimedGraphActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.timed_graph_activity);
        ...
        {
            System.out.println("timedData.txt was not found");
        }
        int trialNum = 1;
        while(input.hasNext())
        {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(TimedGraphActivity.this,
